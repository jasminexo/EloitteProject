...
public class LoginTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if(valid){
                    mAuth.signInWithEmailAndPassword(email.getText().toString(),password.getText()
                        ...
                        public void onSuccess(AuthResult authResult) {
                            Toast.makeText(LoginTestActivity.this, "Logged in Successfully",
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(LoginTestActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
        ...
        goToRegister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(),RegisterTestActivity.class));
            }
        });
    }
